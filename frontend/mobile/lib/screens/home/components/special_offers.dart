  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: GestureDetector(
        onTap: press,
        child: SizedBox(
          width: SizeConfig(context: context).getProportionateScreenWidth(242),
          height: SizeConfig(context: context).getProportionateScreenWidth(100),
          child: ClipRRect(
              ...
              children: [
                ...
                Padding(
                  padding: EdgeInsets.symmetric(
                    horizontal: SizeConfig(context: context).getProportionateScreenWidth(15.0),
                    vertical: SizeConfig(context: context).getProportionateScreenWidth(10),
                  ),
                  child: Text.rich(
                    TextSpan(
