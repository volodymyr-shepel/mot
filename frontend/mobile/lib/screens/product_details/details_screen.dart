...
class DetailsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          ImageCarousel(), // Assuming this is a pre-existing widget for image display
          TopRoundedContainer(
            color: Colors.white,
            child: Column(
              children: [
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          ...
                          QuantitySelector(), // QuantitySelector doesn't need to be expanded if it sizes itself
                        ],
                      ),
                      // ... other children ...
                    ],
